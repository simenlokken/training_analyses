...
session_4_forerunner_255 <- read_csv("session_4_forerunner_255.csv")
session_4_hrm_pro <- read_csv("session_4_forerunner_255.csv")
```
...
session_4_forerunner_255 <- session_4_forerunner_255 |> 
  janitor::clean_names() |> 
 mutate(
    elapsed_time = record_timestamp_s - min(record_timestamp_s),
    heart_rate_percent = record_heart_rate_bpm / 195 * 100
  )

session_4_hrm_pro <- session_4_hrm_pro |> 
  janitor::clean_names() |> 
  mutate(
    elapsed_time = record_timestamp_s - min(record_timestamp_s) / 60,
    heart_rate_percent = record_heart_rate_bpm / 195 * 100
  )

session_4_forerunner_255 |> 
  ggplot() +
  geom_line(aes(x = elapsed_time, y = record_heart_rate_bpm))
```
